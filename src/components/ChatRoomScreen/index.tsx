...
// FC 대신 FunctionComponent 를 사용하라는데??

const ChatRoomScreen: React.FunctionComponent<ChatRoomScreenParams> = ({ history, chatId }) => {
// Note how we used the match.params.chatIdvariable to get the
// selected chat ID. The matchprop is defined and provided to us by
// the <Route />component, since it interfaces directly
// with the ChatRoomScreen
